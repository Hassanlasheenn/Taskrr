...
def run_migration():
    ...
    try:
        ...
        if "postgresql" in db_url or "postgres" in db_url:
            result = db.execute(text("SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = \u0027todos\u0027 AND COLUMN_NAME = \u0027time_estimate\u0027"))
            if result.scalar() == 0:
                print("Adding time_estimate column to todos table...")
